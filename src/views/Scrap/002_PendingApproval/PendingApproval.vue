...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState('npi', ['npiConfigData', 'Category', 'Material', 'npiBuckets', 'CategoryBucket']),
      ...mapGetters('npi', [
        'rootCauseData',
        'rootCauseData',
        'filteredData',
    ...
    methods: {
      ...
      ...mapMutations('app', ['toggleBucketDialog', 'setSelectedItem', 'setDialog', 'setSelectedRowsData', 'setSelectedRowObject', 'setOldValues', 'setPendingApprovalGrid']),
