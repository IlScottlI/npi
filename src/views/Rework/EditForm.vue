            ...
            >
              <v-container>
                ...
                <v-row>
                  ...
                  >
                    <v-select
                      v-model="reworkTypeId"
                      dense
                      :items="[{id:null,name:''},{id:'1',name:'Rework'},{id:'2',name:'Retest'},{id:'3',name:'Consolidation'}]"
                      item-text="name"
                      item-value="id"
                      label="Type"
                    />
                ...
                <v-row>
                  ...
                  >
                    <v-select
                      v-model="reworkProtocolId"
                      dense
                      :items="[{id:null,name:''},{id:'1',name:'Not Started'},{id:'2',name:'Pending'},{id:'3',name:'Approved'}]"
                      item-text="name"
                      item-value="id"
                      label="Rework Protocol Status"
                    />
                  </v-col>
                  <v-col
                    cols="12"
                  ...
                  >
                    ...
                    >
                      <template v-slot:activator="{ on, attrs }">
                        <v-text-field
                          v-model="reworkPalletOrder"
                          label="Pallet Order Date"
                ...
                <v-row>
                  ...
                  >
                    ...
                    >
                      <template v-slot:activator="{ on, attrs }">
                        <v-text-field
                          v-model="reworkPalletArrive"
                          label="Pallet Arrival Date"
                          prepend-icon="mdi-calendar"
                          clearable
                          v-bind="attrs"
                          v-on="on"
  ...
  export default {
    ...
    data () {
      return {
        ...
        loading: false,
        reworkTypeId: null,
        reworkProtocolId: null,
        reworkPalletOrder: null,
        reworkPalletArrive: null,
      }
    },
    computed: {
    ...
    created () {
      if (this.cellData.data.dispositionDeadline) {
        this.dispositionDeadline = this.$moment(this.cellData.data.dispositionDeadline).format('YYYY-MM-DD')
      } else {
      ...
      this.reworkTypeId = this.cellData.data.reworkTypeId
      this.reworkProtocolId = this.cellData.data.reworkProtocolId
      this.reworkPalletOrder = this.cellData.data.reworkPalletOrder
      this.reworkPalletArrive = this.cellData.data.reworkPalletArrive
    },
    methods: {
      ...
      updateEvent () {
        ...
        body.push({
          ...
          updatePrams: {
            ...
            reworkTypeId: this.reworkTypeId,
            reworkProtocolId: this.reworkProtocolId,
            reworkPalletOrder: this.reworkPalletOrder,
            reworkPalletArrive: this.reworkPalletArrive,
            actionNote: 'Rework',
          },
        ...
        fetch('https://tsp-appserver.na.pg.com/APIs/NPI/update.php', {
          ...
          .finally(() => {
            ...
            this.cellData.data.reworkTypeId = this.reworkTypeId
            this.cellData.data.reworkProtocolId = this.reworkProtocolId
            this.cellData.data.reworkPalletOrder = this.reworkPalletOrder
            this.cellData.data.reworkPalletArrive = this.reworkPalletArrive
            this.cellData.data.actionNote = 'Rework'
            this.dialog = false
